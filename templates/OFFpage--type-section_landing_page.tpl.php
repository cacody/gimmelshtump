...
<div id="header" class="clearfix">
  <div class="container">
    <div class="row">
      <div class="span12">
        <?php if ($logo): ?>
        <div id="logo" class="span2"> <a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" rel="home"> <img class="visible-tablet visible-desktop" src="<?php print $logo; ?>" alt="<?php print $site_name; ?>" role="presentation" /><img class="visible-phone mobile-logo" src="http://umdentistry.com/prod/drupal/main/sites/all/themes/fargo/logo3.jpg" glt="<?php print $site_name; ?>" role="presentation"  /></a></div>
        ...
        <?php endif; ?>
		<?php if ($main_menu): ?>
		<div id="main-menu" class="clearfix span8">
		  <div class="container">
		    <div class="navbar">
		      <div class="navbar-inner">
		        ...
		        <div id="nav-search"> 
					<?php print render($page['search_box']); ?> </div>
		        <?php endif; ?>
		        <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse"> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span></a><a class="visible-phone lead menu-text-link" data-toggle="collapse" data-target=".nav-collapse">MENU</a>
...
<div id="main" class="clearfix">
  <div class="container">
    ...
    <?php endif; ?>
    <div id="main-content" class="row hidden-phone hidden-tablet hidden-desktop">
